...
setup(name='cdlib_rest',
      version='0.1.4',
      license='BSD-Clause-2',
      description='REST-ful service for CDlib',
      url='https://github.com/GiulioRossetti/cdlib_rest',
      ...
      keywords='rest-ful api community-discovery node-clustering edge-clustering complex-networks',
